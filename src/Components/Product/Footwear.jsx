...
import { getFootwereProduct } from "../../Server/Apis";
import "./Product.css";
...
export default function FootwearProduct() {
  ...
  const getProducts = async () => {
    ...
    try {
      const data = await getFootwereProduct();
      setIsLoading(true);
  ...
  return (
    <div>
      <div className="product">
        ...
        <ProductSidebar
            catagory="Men's & Womens Footwear"
            product="Products For Men & Women"
            diff1="Shoes"
            diff2="Heels"
            diff3="Men's & Womens Sports Shes"
          />
          <Box sx={{ maxWidth: 200 }}>
            Filter By Discount
            <Slider
